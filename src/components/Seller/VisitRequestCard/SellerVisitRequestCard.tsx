...
export default function SellerVisitRequestCard({
  ...
  return (
    <>
      <Card className="rounded-2xl shadow-sm border border-[#EDEDED] max-w-full w-full">
        <CardContent className="p-4 space-y-4">
          {/*  Responsive Flex Layout */}
          <div className="flex   items-center flex-wrap md:items-start justify-between gap-4">
            <div className="flex  gap-6 w-full">
              ...
              <div className="flex flex-col items-center w-full md:flex-row gap-4">
                ...
                <div className="flex-1 flex flex-col justify-between flex-wrap text-center md:text-start w-full">
                  <div className="flex flex-col w-full max-w-full ">
                    <div className="flex justify-between flex-wrap items-start  max-w-full w-full">
                      <div>
                      ...
                      <div
                        className={clsx(
                          "flex items-center gap-2 px-2 py-1  border rounded-full text-xs sm:text-xs !font-light tracking-wide self-center md:self-center whitespace-nowrap",
