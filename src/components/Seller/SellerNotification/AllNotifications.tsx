...
//       <div className="py-[20px] w-full flex items-start gap-[15px] px-[15px] border border-[#367DC980] bg-[#F4F8FC] rounded-[20px]">
//         <Image
...
//                   30 Min ago
//                 </span>
//                 <div className="h-[14px] w-[14px] rounded-full bg-[blue]"></div>
//               </div>
//             </div>
...
//         </div>
//       </div>
//        <div className="py-[20px] w-full flex items-start gap-[15px] px-[15px] border border-[#E8E0D4] rounded-[20px]">
//         <Image
//           src="/seller/notification/new-visit.png"
//           alt="reject"
//           width={48}
...
//         <div className="py-[20px] w-full flex items-start gap-[15px] px-[15px] border border-[#E8E0D4] rounded-[20px]">
//         <Image
//           src="/seller/notification/payment.png"
//           alt="payment"
//           width={48}
//           height={48}
//           className="w-[48px] h-[48px]"
...
//             <p className="font-[400] text-[16px] text-[#515151]">
//           Security deposit of $2,500 received for Modern Downtown Apartment
//             </p>
//             <div className="mt-[12px] bg-[#F5F5F5] py-[8px] px-[10px] rounded-[12px]">
//               <div className="flex gap-[12px]  items-center">
//                 <Image
...
//          <div className="py-[20px] w-full flex items-start gap-[15px] px-[15px] border border-[#E8E0D4] rounded-[20px]">
//         <Image
//           src="/seller/notification/verification.png"
//           alt="verification"
//           width={48}
//           height={48}
//           className="w-[48px] h-[48px]"
...
//             <p className="font-[400] text-[16px] text-[#515151]">
//         Your seller profile has been verified and approved
//             </p>
