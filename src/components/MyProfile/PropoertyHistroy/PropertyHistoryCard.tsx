        ...
        <div className="flex flex-col sm:flex-row justify-between gap-2">
          ...
          {isRented ? (
            <div className="flex flex-col items-start sm:items-end">
              ...
              {hugReward && (
                <span className="mt-1 text-xs px-2 py-0.5 bg-[#9363E6] text-white rounded-full">
                  {hugReward}
                </span>
              )}
            </div>
          ...
          {isRented ? (
            <>
              <button
                ...
                className="flex items-center justify-center gap-1 border rounded-2xl px-3 py-2 text-sm w-full sm:w-auto"
              >
                <Eye className="w-4 h-4" />
                View Details
              </button>
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <button
                  onClick={() => setIsDialogOpen(true)}
                  className="border text-[#936639] border-[#936639] rounded-2xl px-4 py-2 text-sm font-medium w-full sm:w-auto"
                >
                  View Transactions
                </button>
                <button className="bg-gradient-to-t from-[#A68A64] to-[#936639] text-white rounded-2xl px-4 py-2 text-sm font-medium w-full sm:w-auto">
                  Renew Rent
                </button>
              </div>
            </>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="mt-4 space-y-3 px-2">
            {listing.transactions?.map((txn, idx) => {
              const isOverdue =
                txn.status === "Unpaid" &&
                new Date() > new Date(listing.dueDate || "");
