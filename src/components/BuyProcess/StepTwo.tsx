...
//   return (
//     <div className="max-w-[429px] w-full m-auto bg-[#FAFAFA] px-4 py-6 flex items-center justify-center flex-col">
//       <div className="space-y-4 text-center">
//         <p className="font-[500] text-[28px] text-[#000000]">Upload ID/NIN For Verification</p>
//         <p className="font-[400] text-[16px] text-[#25384E] mb-[64px]">
//           We verify buyers so you can explore and buy properties with confidence
//         </p>
//       </div>

//      <div className="max-w-[428px] w-full bg-[#FFFFFF] rounded-[12px] p-[20px]">
//          <div className="shadow-[0px_5px_8px_0px_#D4C3FF4F] flex items-center justify-center flex-col gap-[10px] p-[20px] rounded-[25px]">
//               <Image
...
//             />
//             <p className="font-[500] text-[16px] text-[#25384E]" >Upload Your ID/NIN</p>
//             <p className="font-[400] text-[12px] text-[#44576D]">Accepted formats are .jpg, .png, .pdf</p>
//          </div>
//              <button
...
const StepTwo: React.FC<StepTwoProps> = ({ onConfirm }) => {
  ...
  const handleSubmit = () => {
    ...
    // Here you can send the file to your backend or form data handler.
